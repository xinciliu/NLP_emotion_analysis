...
class FFNN(nn.Module):
    def __init__(self, input_dim, h):
        ...
        self.activation = nn.ReLU()  # The rectified linear unit; one valid choice of activation function    #changed for Bug 2
    ...
    def forward(self, input_vector):
        ...
        predicted_vector = self.softmax(z2, dim=5)  # changed for Bug 2
